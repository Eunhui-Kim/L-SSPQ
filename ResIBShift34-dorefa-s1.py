...
if __name__ == '__main__':
    ...
    parser.add_argument('--log', default='train_log/ResIBShift34-dorefa-flr')
    parser.add_argument('--eta_min', help='learning rate eta', default=1e-6)
    parser.add_argument('--max_epoch', default=200)
    parser.add_argument('--base_lr', default=0.1)
    parser.add_argument('--wup_length', default=30)
